    ...
    <div className="h-screen flex flex-col bg-gradient-to-br from-background via-background to-primary/5">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="container h-full px-4 pt-6 pb-0">
          ...
          {/* Filters */}
          <div className="bg-card rounded-2xl border border-border p-6 shadow-lg flex-shrink-0">
          ...
          {/* Table */}
          <div className="bg-card rounded-t-2xl border border-border shadow-lg overflow-hidden flex-1 flex flex-col min-h-0 mb-0 pb-0">
            {loading ? (
